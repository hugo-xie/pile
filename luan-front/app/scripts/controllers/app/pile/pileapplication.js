app.controller('pileapplicationController', ['$scope','$stateParams','ResTool','terminalRes', function($scope,$stateParams,ResTool,terminalRes){
   $scope.test = function(){
     if ($scope.upall) {
    $scope.upid = false;
...
$scope.upload = function(){
    ...
    var postbody = {
      ...
      base:image.base,
      md5sum:image.md5sum,
      base64value:image.base64value,
      binarybase64value:image.binarybase64value,
      binarymd5sum:image.binarymd5sum
    }
    var promise = ResTool.httpPostWithToken(terminalRes.upload,{},{
      version:image.version,
      base:image.base,
      md5sum:image.md5sum,
      base64value:image.base64value,
    ...
    var req = $.ajax({
        ...
        dataType: 'json',
        method: 'POST',
        url: 'http://localhost:5000/api/v1_0/terminal_image/add',
